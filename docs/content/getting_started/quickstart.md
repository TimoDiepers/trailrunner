...
```text
no_producer: 5000.0 MJ of https://vocab.sentier.dev/products/heat
no_producer: 400.0 kWh of https://vocab.sentier.dev/products/electricity
```
...
!!! tip "`no_producer` vs `coverage_excluded`"
